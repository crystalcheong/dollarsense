  ...
  Widget build(BuildContext context) {
    ...
    return loading ? Loading() : Column(
      children: <Widget>[
        ...
        //Header title
        Text('Edit Card', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
        SizedBox(height: 20,),
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration( 
                        hintText: 'Card Number', hintStyle: TextStyle(color:Colors.grey[500] ),
                        border: InputBorder.none,
                        enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: Color(0xFF768cfc), width: 2.0)),
                  ...
                  FormInput(
                    ...
                    valHandler: (val) => val.isEmpty ? 'Enter holder name' : null,
                    changeHandler: (val) => setState(() => _holderName = val),
                    inputFormatter: [
                      WhitelistingTextInputFormatter(RegExp(r'^([a-zA-Z][a-zA-Z]*) ?[a-zA-Z]*$')),
                    ],
                  ),
                    ...
                    child: FullButton(
                      ...
                      handler: () async {
                        ...
                        if(_formKey.currentState.validate()){
                          ...
                          //REMOVAL
                          await DatabaseService(uid: globals.userData.uid).deleteBankCard(
                            widget.bankCard
                          );

                          globals.wallet.removeWhere((t) => identical(t, widget.bankCard));
                          ...
                          entry = alertOverlay( 
                            AlertNotification(text: 'Card updated', color: Colors.deepPurple)
                          );
                          ...
                          entry = alertOverlay( 
                            AlertNotification(text: 'Cannot add card with invalid fields!', color: Colors.red[400]),
                            tapHandler: (){
                              entry?.remove();
                              entry = null;
                            }
                  ...
                  GestureDetector(
                    onTap: () async {
                        ...
                        Widget deleteButton = FlatButton(
                          ...
                          onPressed: () async { 
                            ...
                            List<TransactionRecord> linkedRecords = transactions.where((t) => t.cardNumber == widget.bankCard.cardNumber).toList();

                            linkedRecords.forEach((record) async {
                              //TRANSACTION DELETION
                              await DatabaseService(uid: globals.userData.uid).deleteTransactionRecord(record);
                              globals.transactions.removeWhere((t) => identical(t, record));
                            });

                            //CARD DELETION
                            await DatabaseService(uid: globals.userData.uid).deleteBankCard(widget.bankCard);
                            globals.wallet.removeWhere((t) => identical(t, widget.bankCard));
                            ...
                            entry = alertOverlay(AlertNotification(text: 'Card deleted', color: Colors.red[400]));
                            Navigator.of(globals.scaffoldKey.currentContext).overlay.insert(entry);
                            overlayDuration(entry);
                      ...
                      showDialog(
                        ...
                        builder: (context) => dialog(
                          ...
                          [ 
                            FlatButton(child: Text("Cancel".toUpperCase()), onPressed: () => Navigator.of(globals.scaffoldKey.currentContext).pop()),
                            deleteButton
                          ],
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Text("Delete Card", style: TextStyle(decoration: TextDecoration.underline)),
                      ],
                    ),
                  ),

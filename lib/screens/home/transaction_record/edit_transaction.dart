                    ...
                    child: FullButton(
                      ...
                      handler: () async {
                        ...
                        if(_formKey.currentState.validate()){
                          ...
                          entry = alertOverlay( 
                            AlertNotification(text: 'Transaction updated', color: Colors.deepPurple)
                          );
                          ...
                          entry = alertOverlay( 
                            AlertNotification(text: 'Cannot add transaction with invalid fields!', color: Colors.red[400]),
                            tapHandler: (){
                              entry?.remove();
                              entry = null;
                            }

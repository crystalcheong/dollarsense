                ...
                children: <Widget>[
                  ...
                  FormInput(
                    ...
                    inputFormatter: [
                        ...
                        WhitelistingTextInputFormatter(RegExp(r'(^[1-9]\d*\.?\d{0,2})$'))
                    ],
                  ),
                    ...
                    child: FullButton(
                        ...
                        handler: () async {
                          ...
                          if(_formKey.currentState.validate()){
                            ...
                            entry = alertOverlay( 
                              AlertNotification(text: 'Transaction added', color: Colors.deepPurple)
                            );
                            ...
                            entry = alertOverlay( 
                              AlertNotification(text: 'Cannot add transaction with incomplete fields!', color: Colors.red[400]),
                              tapHandler: (){
                                entry?.remove();
                                entry = null;
                              }

...
const kLightPrimary = Color(0xFF34CCFD);

///HOME
const kPrimary = Color(0xFF5CA6FD);
const kDarkPrimary = Color(0xFF768CFC);

///WALLET

const kLightSecondary = Color(0xFF8B70FD);

///STATISTICS
const kSecondary = Color(0xFFA054FE);
const kDarkSecondary = Color(0xFFB333FA);
...
class FullButton extends StatelessWidget {
  ...
  const FullButton(
      {this.icon, @required this.text, @required this.color, this.handler});
...
Widget dialog(String title, String content, List<Widget> actions,
        {Color titleColor}) =>
    AlertDialog(
...
final kFieldDecoration = InputDecoration(
  border: InputBorder.none,
  enabledBorder: UnderlineInputBorder(
      borderSide: BorderSide(color: Color(0xffbec2c3), width: 2.0)),
  focusedBorder: UnderlineInputBorder(
      borderSide: BorderSide(color: Colors.black, width: 2.0)),
  errorBorder: UnderlineInputBorder(
      borderSide: BorderSide(color: Colors.redAccent, width: 2.0)),
